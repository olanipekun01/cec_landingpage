...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($fName) && !empty($lName)  && !empty($email) && !empty($phone) && !empty($industry) && filter_var($email, FILTER_VALIDATE_EMAIL)) {
        // Email details
        $to = "auictdrive@gmail.com, internshipachievers@gmail.com, internshipachievers@glocotrust.com, employmenttrainingachievers@glocotrust.com";  // Replace with your own email
