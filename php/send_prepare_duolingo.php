...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($name)  && !empty($email) && !empty($phone) && !empty($dateOfBirth) && filter_var($email, FILTER_VALIDATE_EMAIL)) {
        // Email details
        $to = "auictdrive@gmail.com, prepareforduolingoachievers@gmail.com, admissionsachievers@glocotrust.com";  // Replace with your own email
        $subject = "New Prepare for Duolingo Form Submission";
